# -*- coding: utf-8 -*-
"""pose assessment.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CR9gAXjh8pSb3Rn30afqy3KZa2xVUDCr
"""
...
def assessment(inpt_img):
  ...
  with mp_pose.Pose(min_detection_confidence =0.5, min_tracking_confidence = 0.5) as pose:
      ...
      while cap.isOpened():
          ...
          mp_drawing.draw_landmarks(image, results.pose_landmarks, mp_pose.POSE_CONNECTIONS,
                                  mp_drawing.DrawingSpe(color=(245,117,66), thickness=2, circle_radius=4),
...
#     # Wait for a key press or break the loop if 'q' is pressed
#     if cv2.waitKey(1) & 0xFF == ord('q'):
#         break

path = "/content/yoga22.jpg"
x = extractKeypoint(path)
x
...
with mp_pose.Pose(min_detection_confidence =0.5, min_tracking_confidence = 0.5) as pose:
    ...
    #     # Create a VideoWriter object to save the result
        # result_path = '/content/result.mp4'
        # result_writer = cv2.VideoWriter(result_path, cv2.VideoWriter_fourcc(*'MP4V'), fps, (frame_width, frame_height))


    #     result_writer.write(image)

    #     # After the loop ends, release resources
...
def create_frame(data):
    # Convert base64 data to image array
...
# Display the JavaScript code to create the video output
display(output)

# Create the JavaScript function to receive the frame
display(IPython.display.Javascript("""
    function createFrame(imgData) {
...
while True:
    ...
    jpg_as_text = b64encode(buffer.tostring()).decode('utf-8')

    # Send frame to the output
    output.eval_js('createFrame("{}")'.format(jpg_as_text))
